        ...
        <section class="register">
            ...
            @csrf
                ...
                <div class="register__group">
                    ...
                    <input placeholder="Login" type="text" name="name" class="register__login @error('name') is-invalid @enderror" required>
                ...
                <div class="register__group">
                    ...
                    <input placeholder="Email" type="email" name="email" class="register__email @error('email') is-invalid @enderror" required>
                ...
                <div class="register__group">
                    ...
                    <input placeholder="Password" type="password" name="password" class="register__password @error('password') is-invalid @enderror" required>
                ...
                <div class="register__group">
                    <i class="fas fa-key fa-custom"></i>
                    <input placeholder="Confirm Password" type="password" name="password_confirmation" class="register__password" required>
                </div>
